...
FragTrap::FragTrap()
{
    ...
    std::cout << "FragTrap arrived" << std::endl;
}
...
FragTrap::FragTrap(std::string name)
{
    this->_name = name;
    this->intializeDefaultValue();
    std::cout << this->_type << " " << this->_name << " was delivered from the factory"
    << std::endl;
}
...
void FragTrap::vaulthunter_dot_exe(std::string const & target)
{
    ...
    {
        std::cout << this->_type << " " << this->_name << " is out of energy, to make attack" << std::endl;
    }
}
