...
{
    std::cout << "NinjaTrap tryed attack a " << target.getName() << ", but scav " << 
...
{
    std::cout << "NinjaTrap tryed attack " << target.getName() << " , why??" << std::endl;
}

void NinjaTrap::ninjaShoebox(NinjaTrap & target)
{
    std::cout << "NinjaTrap attacked " << target.getName() << " with shuriken and dealed " << this->_rangeDamage << " damage" << std::endl;
}
